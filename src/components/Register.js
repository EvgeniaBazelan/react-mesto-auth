...
function Register (props) {
    ...
    <form className="form form_black" name="register"  onSubmit={props.onSubmit} >
        ...
        <fieldset className="form__personal-info form__personal-info_black">
            <input value={props.valueEmail}  onChange={props.onChangeEmail} className="form__item form__item_black " id='email' placeholder="email" name="email" type="email" required minLength="2"
                   maxLength="40"/>
            <span className="form__item-error email-error "/>
            <input value={props.valuePassword}  onChange={props.onChangePassword} className="form__item form__item_black " id='password' placeholder="password" name="password" type="password"
